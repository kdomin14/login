...
<main>
  ...
  <img src="../assets/cooper.jpg" alt="Placeholder image">
  </figure>
  </div> 
  ...
  <h1 class="title is-4">2020-21 Panini Prizm LaMelo Ball Rookie Card #278</h1>
   ...
   <div class="is-pulled-left">
    ...
    <div class="card-image">
    <figure class="image is-4by3">
    <img src="../assets/dak.jpg" alt="Placeholder image">
    </figure>
    </div> 
    <div class="card-content">
    <div class="media">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
     ...
     <i class="fa fa-star"></i>
      ...
      <img src="../assets/elliot.jpg" alt="Placeholder image">
      </figure>
      </div> 
      <div class="card-content">
      <div class="media">
		...
		<div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-coolGray-600">
			...
			<div class="flex flex-col justify-center pt-6 lg:pt-0">
				<div class="flex justify-center space-x-4">
					<a href="#" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-lightBlue-600 text-coolGray-50">
