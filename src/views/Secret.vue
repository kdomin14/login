<template>
<header>
    <div class="w-full bg-cover bg-center" style="height:32rem; background-image: url(https://cdn5.vectorstock.com/i/1000x1000/84/89/vip-member-vector-3908489.jpg);">
...
<script>
import products from "C:\\Windows\\System32\\projects\\login\\secret.json";
