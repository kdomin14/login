<template>
<header>
    <div class="w-full bg-cover bg-center" style="height:32rem; background-image: url(https://image.shutterstock.com/image-illustration/blue-question-mark-on-background-260nw-1174244842.jpg);">
