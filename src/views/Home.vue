...
<header>
  ...
  <section class="m-4 md:m-8 bg-coolGray-100 text-coolGray-800">
		<div class="container mx-auto p-4 my-6 space-y-2 text-center">
			...
			<p class="text-coolGray-600">Libero minima optio qui</p>
		</div>
  ...
  <section class="py-6 bg-coolGray-100 text-coolGray-900">
		<div class="container mx-auto flex flex-col justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row">
			<div class="flex flex-col space-y-4 text-center lg:text-left">
				...
				<p class="text-lg">Subscribe to get member exclusive content!</p>
			</div>
			<div class="flex flex-row items-center self-center justify-center flex-shrink-0 shadow-md lg:justify-end">
				<div class="flex flex-row">
					...
					<button type="button" class="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-lightBlue-600 text-coolGray-50">Subscribe</button>
				</div>
			</div>
		</div>
	</section>
